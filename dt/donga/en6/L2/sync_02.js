	...
	mp_data = {  // MP3 sync
		...
		data_p023_01: { // 파일명 -
			...
			dialogue: [
				...
				["Harry, why are you upset?", "너는 왜 화가 났니?"],
		...
		data_p024_01: { // 파일명 -
			...
			dialogue: [
				...
				["Worry doll?", "걱정 인형?"],
				["Tell the doll about your worry. She can help you.", "인형에게 네 걱정을 말해 봐. 그녀는 너를 도와줄 거야."],
//				["She can help you.", "그녀는 너를 도와줄 거야."],
		...
		data_p024_02: { // 파일명 -
			...
			dialogue: [
				...
				["", "스웨덴 사람들은 달라 호스가 가정에는 평화를, 개인에게는 행복을 가져다 준다고 믿는답니다."],
		...
		data_p026_01_follow: { // 따라하기파일적용 테스트 용
			subtitle: [
				[9.9, 14.5, 1],
				[16.3, 20.4, "2_3_4"],
				[20.6, 25.6, "2_3_4"],
