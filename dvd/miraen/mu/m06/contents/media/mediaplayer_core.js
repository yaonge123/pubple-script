...
var mediaplayer_core = function (p_parent) {
        ...
        return {
                ...
                onLoadedData: function () {
                        ...
                        if (_parent._hierarchy().btnWayloop != null) { _this.setLoop(_parent._module().notes.b_way_loop()); }
                ...
                castPlay: function (option) {
                        ...
                        if (_parent._module().follow != null) { _parent._module().follow.chkFollowPoint(); }
                ...
                updateUI: function () {
                        // 개발
                        if (dev_trace_detail == _parent._id()) { console.log("# " + _parent._id() + ": core.updateUI()"); }
