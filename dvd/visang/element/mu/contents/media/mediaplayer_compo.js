...
var mediaplayer_compo_subtitle = function (p_parent) {
        ...
        return {
                ...
                init: function () {
                        ...
                        // 접근자
                        _parent._tag().data = ($(_parent._ele()).attr("data") != null) ? $(_parent._ele()).attr("data") : "data_" + _parent._id();
                        _parent._tag().subtitle = ($(_parent._ele()).attr("subtitle") != null) ? $(_parent._ele()).attr("subtitle") : "subtitle_" + _parent._id();
                ...
                onCastChangeMedia: function (p_data, p_subtitle) {
                        ...
                        // 접근자
                        _parent._tag().data = (p_data != null) ? p_data : "data_" + _parent._id();
...
// mediaplayer_compo_notes 악보 * moveMedia 관련 추가 코드는 없는걸로 가정 / 추적 미적용
var mediaplayer_compo_notes = function (p_parent) {
        ...
        return {
                ...
                init: function () {
                        ...
                        _parent._tag().data = ($(_parent._ele()).attr("data") != null) ? $(_parent._ele()).attr("data") : "data_" + _parent._file();
                        _parent._tag().notes = ($(_parent._ele()).attr("notes") != null) ? $(_parent._ele()).attr("notes") : "notes_" + _parent._id();
                ...
                b_way_loop: function () { return b_way_loop; },
                ...
                updateUI: function () {
                        ...
                        if (i_current_listen != -1) {
                                ...
                                if (hie.btnWayloop != null) {
                                        ...
                                        _parent._module().core.setLoop(b_way_loop);
                                }
...
var mediaplayer_compo_thumbnail = function (p_parent) {
        ...
        return {
                ...
                init: function () {
                        ...
                        // 접근자
                        _parent._tag().data = ($(_parent._ele()).attr("data") != null) ? $(_parent._ele()).attr("data") : "data_" + _parent._id();
                        _parent._tag().thumbnail = ($(_parent._ele()).attr("thumbnail") != null) ? $(_parent._ele()).attr("thumbnail") : "thumbnail_" + _parent._id();
