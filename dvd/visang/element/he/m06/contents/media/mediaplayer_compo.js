        ...
        return {
                ...
                onUpdateUI: function (str) {
                        ...
                        if (str != null) {
                                switch (str) {
                                        case "on": // 기능 유효
                                                if ($(btn).hasClass("btnStopOff") == true) { $(btn).removeClass("btnStopOff"); }
                                                if ($(btn).hasClass("btnStopOn") == false) { $(btn).addClass("btnStopOn"); }
                                                break;
                                        case "off": // 기능 무효
                                                if ($(btn).hasClass("btnStopOn") == true) { $(btn).removeClass("btnStopOn"); }
                                                if ($(btn).hasClass("btnStopOff") == false) { $(btn).addClass("btnStopOff"); }
                                                break;
                                }
                        }
...
var mediaplayer_compo_volume = function (p_parent) {
        ...
        return {
                ...
                updateModule: function () {
                        ...
                        // 음소거 버튼
                        if (b_vol_sound == true) { // 사운드 on 상태
                                if ($(btn).hasClass("btnSoundOff") == true) { $(btn).removeClass("btnSoundOff"); }
                                if ($(btn).hasClass("btnSoundOn") == false) { $(btn).addClass("btnSoundOn"); }
                        } else { // 사운드 off 상태
                                if ($(btn).hasClass("btnSoundOn") == true) { $(btn).removeClass("btnSoundOn"); }
                                if ($(btn).hasClass("btnSoundOff") == false) { $(btn).addClass("btnSoundOff"); }
                        }
...
var mediaplayer_compo_repeat = function (p_parent) {
        ...
        return {
                ...
                updateModule: function () {
                        ...
                        // 갱신
                        if (f_repeat_start != -1) { // on
                                if ($(btnStart).hasClass("btnRepeatStartOff") == true) { $(btnStart).removeClass("btnRepeatStartOff"); }
                                if ($(btnStart).hasClass("btnRepeatStartOn") == false) { $(btnStart).addClass("btnRepeatStartOn"); }
                        } else { // off
                                if ($(btnStart).hasClass("btnRepeatStartOn") == true) { $(btnStart).removeClass("btnRepeatStartOn"); }
                                if ($(btnStart).hasClass("btnRepeatStartOff") == false) { $(btnStart).addClass("btnRepeatStartOff"); }
                        }
                        if (f_repeat_end != -1) { // on
                                if ($(btnEnd).hasClass("btnRepeatEndOff") == true) { $(btnEnd).removeClass("btnRepeatEndOff"); }
                                if ($(btnEnd).hasClass("btnRepeatEndOn") == false) { $(btnEnd).addClass("btnRepeatEndOn"); }
                        } else { // off
                                if ($(btnEnd).hasClass("btnRepeatEndOn") == true) { $(btnEnd).removeClass("btnRepeatEndOn"); }
                                if ($(btnEnd).hasClass("btnRepeatEndOff") == false) { $(btnEnd).addClass("btnRepeatEndOff"); }
                        }
...
var mediaplayer_compo_loop = function (p_parent) {
        ...
        return {
                ...
                updateModule: function () {
                        ...
                        // 갱신
                        if (b_loop_on == true) { if ($(btn).hasClass("on") == false) { $(btn).addClass("on"); } }
                        else { if ($(btn).hasClass("on") == true) { $(btn).removeClass("on"); } }

                        if (b_loop_on == true) { // on
                                if ($(btn).hasClass("btnLoopOff") == true) { $(btn).removeClass("btnLoopOff"); }
                                if ($(btn).hasClass("btnLoopOn") == false) { $(btn).addClass("btnLoopOn"); }
                        } else { // off
                                if ($(btn).hasClass("btnLoopOn") == true) { $(btn).removeClass("btnLoopOn"); }
                                if ($(btn).hasClass("btnLoopOff") == false) { $(btn).addClass("btnLoopOff"); }
                        }
        ...
        return {
                ...
                updateModule: function () {
                        ...
                        switch (OPTION_PLAYBACKRATE_TYPE) {
                                ...
                                case 1:
                                        // 모두 해제
                                        if ($(hie.btnSlow).hasClass("on") == true) { $(hie.btnSlow).removeClass("on"); }
                                        if ($(hie.btnNormal).hasClass("on") == true) { $(hie.btnNormal).removeClass("on"); }
                                        if ($(hie.btnFast).hasClass("on") == true) { $(hie.btnFast).removeClass("on"); }

                                        // 설정
                                        switch (f_rate_set) {
                                                case OPTION_PLAYBACKRATE_VALUE_SLOW: $(hie.btnSlow).addClass("on"); break;
                                                case 1.0: $(hie.btnNormal).addClass("on"); break;
                                                case OPTION_PLAYBACKRATE_VALUE_FAST: $(hie.btnFast).addClass("on"); break;
                                        }
                                        break;
                                case 2:
                                        // 모두 해제
                                        if ($(hie.btnPlaybackrate).hasClass("btnPlaybackrateFast") == true) { $(hie.btnPlaybackrate).removeClass("btnPlaybackrateFast"); }
                                        if ($(hie.btnPlaybackrate).hasClass("btnPlaybackrateNormal") == true) { $(hie.btnPlaybackrate).removeClass("btnPlaybackrateNormal"); }
                                        if ($(hie.btnPlaybackrate).hasClass("btnPlaybackrateSlow") == true) { $(hie.btnPlaybackrate).removeClass("btnPlaybackrateSlow"); }

                                        // 설정
                                        switch (f_rate_set) {
                                                case OPTION_PLAYBACKRATE_VALUE_SLOW: $(hie.btnPlaybackrate).addClass("btnPlaybackrateSlow"); break;
                                                case 1.0: $(hie.btnPlaybackrate).addClass("btnPlaybackrateNormal"); break;
                                                case OPTION_PLAYBACKRATE_VALUE_FAST: $(hie.btnPlaybackrate).addClass("btnPlaybackrateFast"); break;
                                        }
                                        break;
                        }
...
var mediaplayer_compo_fullscreen = function (p_parent) {
        ...
        return {
                ...
                // 연결
                getCompoUI: function () { return [_parent._hierarchy().btnFullscreen]; },
                ...
                updateModule: function () {
                        ...
                        // 갱신
                        if (VIDEO_CUSTOM_FULLSCREEN == true) { // 커스텀
                                if (_parent._option().fullscreen_target == true) {
                                        if ($(btn).hasClass("btnFullscreenOff") == true) { $(btn).removeClass("btnFullscreenOff"); }
                                        if ($(btn).hasClass("btnFullscreenOn") == false) { $(btn).addClass("btnFullscreenOn"); }
                                } else {
                                        if ($(btn).hasClass("btnFullscreenOn") == true) { $(btn).removeClass("btnFullscreenOn"); }
                                        if ($(btn).hasClass("btnFullscreenOff") == false) { $(btn).addClass("btnFullscreenOff"); }
                                }
                        } else { // 네이티브
                                if (b_fullscreen_on == true) { // on
                                        if ($(btn).hasClass("btnFullscreenOff") == true) { $(btn).removeClass("btnFullscreenOff"); }
                                        if ($(btn).hasClass("btnFullscreenOn") == false) { $(btn).addClass("btnFullscreenOn"); }
                                } else { // off
                                        if ($(btn).hasClass("btnFullscreenOn") == true) { $(btn).removeClass("btnFullscreenOn"); }
...
var mediaplayer_compo_cover = function (p_parent) {
        ...
        return {
                        ...
                        if (VIDEO_EXIST_BTN_COVER == true) {
                                ...
                                if (tools_chkMobileOS() == "N/A") {
                                        document.addEventListener("mousemove", function (event) {
                                                ...
                                                // 인아웃 판단
                                                var inout = tools_chkInout(event, hie.mediaContainer);
                ...
                onButtonClick: function (tag, idx, btn) {
                        ...
                        // 재생
                        if (_parent._media().paused == true) { _parent._module().core.castPlay(); }
                        else { _parent._module().core.castPause(); }
                ...
                setPoster: function () {
                        ...
                        // 포스터
                        /*
                        var path_source = PATH_MEDIA_VIDEO + _parent._file();
                        var path_split = path_source.split("/");
                        var path_refine = "";
                        for (var ii = 0 ; ii < path_split.length - 1 ; ii++) { path_refine += path_split[ii] + "/"; }*/
                        var url = PATH_MEDIA_VIDEO + _parent._file() + ".jpg";
                        url = encodeURI(url);
                        $(_parent._hierarchy().poster).css("background-image", "url(" + url + ")");
                ...
                updateModule: function (show) {
                        ...
                        if (show == true) {
                                ...
                                //if (VIDEO_EXIST_BTN_COVER == true) { $(hie.btnCover).css("display", "none"); }
...
var mediaplayer_compo_subtitle = function (p_parent) {
        ...
        var i_language_current = -1; // 언어 상태 (-1:기능미동작, 0:영어, 1:영어+한글)
        ...
        return {
                ...
                init: function () {
                        ...
                        // 접근자
                        _parent._tag().data = ($(_parent._ele()).attr("data") != null) ? $(_parent._ele()).attr("data") : _parent._id();
                        _parent._tag().subtitle = ($(_parent._ele()).attr("subtitle") != null) ? $(_parent._ele()).attr("subtitle") : _parent._id();
                        ...
                        if (hie.btnFontsizeUp != null) {
                                ...
                                $(hie.btnFontsizeUp).hover(
                                        function (event) { // handle in
                                                // 조건검사
                                                if (i_subtitle_show == 0) { return; }

                                                // 동작
                                                var btn = event.target;
                                                if ($(btn).hasClass("hover") == false) { $(btn).addClass("hover"); }
                                        },
                                function (event) { // handle out
                                        // 동작
                                        var btn = event.target;
                                        if ($(btn).hasClass("hover") == true) { $(btn).removeClass("hover"); }
                                }
                                );
                                $(hie.btnFontsizeDown).hover(
                                        function (event) { // handle in
                                                // 조건검사
                                                if (i_subtitle_show == 0) { return; }
                ...
                getCompoUI: function (str) {
                        switch (str) {
                                case "btnSubtitle": return [_parent._hierarchy().btnSubtitle];
                                case "btnLanguage": return [_parent._hierarchy().btnLanguage];
                                case "btnFontsize": return [_parent._hierarchy().btnFontsizeDown, _parent._hierarchy().btnFontsizeUp];
                        }
                },
                ...
                onCastChangeMedia: function (p_data, p_subtitle) {
                        ...
                        // 접근자
                        _parent._tag().data = (p_data != null) ? p_data : _parent._id();
                        _parent._tag().subtitle = (p_subtitle != null) ? p_subtitle : _parent._id();
                ...
                onTimeUpdate: function () {
                        ...
                        if (obj_subtitle_container != null) {
                                if (time == 0 && _parent._option().subtitle_scroll == true) {
                ...
                setSubtitle: function () {
                        ...
                        obj_subtitle_container = $("#subtitle_" + tag_subtitle)[0];
                        ...
                        if (b_is_video == false) {
                                $.each(dic_subtitle_target, function (key, val) {
                                        ...
                                        var en = $(val).find(".tEng")[0];
                                        if (en != null) {
                                                if (_parent._category() != "video" && $(en).hasClass("noSound") == false) {
                                                        en.idx = key;
                        ...
                        ar_subtitle_sync = (dicMediaData == null || dicMediaData["data_" + tag_data] == null || dicMediaData["data_" + tag_data].subtitle == null) ? null : dicMediaData["data_" + tag_data].subtitle;
                        ...
                        if (b_is_video == true) {
                                ar_subtitle_dialogue = (dicMediaData == null || dicMediaData["data_" + tag_data] == null || dicMediaData["data_" + tag_data].dialogue == null) ? null : dicMediaData["data_" + tag_data].dialogue;
                ...
                updateUI: function () {
                        ...
                        if (hie.btnSubtitle != null) {
                                switch (i_subtitle_show) {
                                        case 0:
                                                // 버튼
                                                if ($(hie.btnSubtitle).hasClass("btnSubtitleOn") == true) { $(hie.btnSubtitle).removeClass("btnSubtitleOn"); }
                                                if ($(hie.btnSubtitle).hasClass("btnSubtitleOff") == false) { $(hie.btnSubtitle).addClass("btnSubtitleOff"); }

                                                // 언어 버튼
                                                if (hie.btnLanguage != null) {
                                                        if ($(hie.btnLanguage).hasClass("btnLanguageOn") == true) { $(hie.btnLanguage).removeClass("btnLanguageOn"); }
                                                        if ($(hie.btnLanguage).hasClass("btnLanguageOff") == true) { $(hie.btnLanguage).removeClass("btnLanguageOff"); }
                                                        if ($(hie.btnLanguage).hasClass("btnLanguageDefault") == false) { $(hie.btnLanguage).addClass("btnLanguageDefault"); }
                                                }

                                                // 자막 컨테이너
                                                $(obj_subtitle_container).css("display", "none");
                                                break;
                                        case 1:
                                                // 버튼
                                                if ($(hie.btnSubtitle).hasClass("btnSubtitleOff") == true) { $(hie.btnSubtitle).removeClass("btnSubtitleOff"); }
                                                if ($(hie.btnSubtitle).hasClass("btnSubtitleOn") == false) { $(hie.btnSubtitle).addClass("btnSubtitleOn"); }

                                                // 자막 컨테이너
                                                $(obj_subtitle_container).css("display", "inline");
                                                break;
                                }
                        }

                        // 언어
                        if (hie.btnLanguage != null && i_subtitle_show != 0) {
                                switch (i_language_current) {
                                        case 0:
                                                // 버튼
                                                if ($(hie.btnLanguage).hasClass("btnLanguageOn") == true) { $(hie.btnLanguage).removeClass("btnLanguageOn"); }
                                                if ($(hie.btnLanguage).hasClass("btnLanguageOff") == false) { $(hie.btnLanguage).addClass("btnLanguageOff"); }

                                                // 언어
                                                $($(obj_subtitle_container).find(".tKor")).each(function (idx) { $(this).css("display", "none"); });
                                                $($(obj_subtitle_container).find(".tEng")).each(function (idx) { $(this).css("display", "inline"); });
                                                break;
                                        case 1:
                                                // 버튼
                                                if ($(hie.btnLanguage).hasClass("btnLanguageOff") == true) { $(hie.btnLanguage).removeClass("btnLanguageOff"); }
                                                if ($(hie.btnLanguage).hasClass("btnLanguageOn") == false) { $(hie.btnLanguage).addClass("btnLanguageOn"); }

                                                // 언어
                                                $($(obj_subtitle_container).find(".tEng")).each(function (idx) { $(this).css("display", "none"); });
                                                $($(obj_subtitle_container).find(".tKor")).each(function (idx) { $(this).css("display", "inline"); });
                                                break;
                                }
                        }
...
var mediaplayer_compo_roleplay = function (p_parent) {
        ...
        return {
                ...
                onButtonClick: function (tag, idx, btn) {
                        ...
                        // 변경
                        ar_roleplay_current[role - 1] = !ar_roleplay_current[role - 1];
                ...
                onUpdateUI: function () {
                        ...
                        for (var ii = 0 ; ii < ar_roleplay_current.length ; ii++) {
                                ...
                                var btn_off = "btnRoleplay" + (ii + 1) + "Off";
                                var btn_on = "btnRoleplay" + (ii + 1) + "On";
                                if (ar_roleplay_current[ii] == true) {
                                        if ($(btn).hasClass(btn_off) == true) { $(btn).removeClass(btn_off); }
                                        if ($(btn).hasClass(btn_on) == false) { $(btn).addClass(btn_on); }
                                } else {
                                        if ($(btn).hasClass(btn_on) == true) { $(btn).removeClass(btn_on); }
                                        if ($(btn).hasClass(btn_off) == false) { $(btn).addClass(btn_off); }
                                }
                        }
                        ...
                        if (ar_roleplay_ico != null) {
                                for (var ii = 0 ; ii < ar_subtitle_sync.length ; ii++) {
                                        ...
                                        // 갱신
                                        if (ar_roleplay_current[role - 1] == true) { if ($(ico).hasClass("on") == false) { $(ico).addClass("on"); } }
                                        else { if ($(ico).hasClass("on") == true) { $(ico).removeClass("on"); } }
                                }
                        }
                ...
                setRoleplay: function () {
                        ...
                        // 데이터 정리
                        var tag_data = _parent._tag().data;
                        var dic = dicMediaData["data_" + tag_data];
                        ...
                        // 자막으로 판단 (비디오에서는 불가능)
                        if (_parent._category() != "video" && _parent._module().subtitle != null) {
                                // 준비
                                var tag_subtitle = _parent._tag().subtitle;
                                var subtitle_container = $("#subtitle_" + tag_subtitle)[0];
...
// mediaplayer_compo_notes 악보 * changeMedia, moveMedia 관련 추가 코드는 없는걸로 가정 / 추적 미적용
var mediaplayer_compo_notes = function (p_parent) {
        ...
        return {
                ...
                init: function () {
                        ...
                        // 접근자
                        _parent._tag().data = ($(_parent._ele()).attr("data") != null) ? $(_parent._ele()).attr("data") : _parent._id();
                        _parent._tag().notes = ($(_parent._ele()).attr("notes") != null) ? $(_parent._ele()).attr("notes") : _parent._id();
                ...
                onHardReset: function () {
                        ...
                        if (i_current_tune != 0) {
                                // 음원 변경
                                changeMedia(_parent._id(), tools_getSourceFileName(_parent._file()), tools_getSourceFileName(_parent._file()), null, "tuneNormal");
                                _this.updateUI();
                        } else {
                                // 일반 리셋
                                _this.onReset();
                ...
                onReset: function () {
                        ...
                        // 데이터 준비
                        var dic = dicMediaData["data_" + _parent._tag().data];
                        var data = dic.notes;
                ...
                onButtonClick: function (tag, idx, btn) {
                        ...
                        switch (tag) {
                                ...
                                case "btnFocus": // 포커스 가시 여부
                                        ...
                                        if (b_focus_note == true) { _this.revertFocus(); } // 기억했던 포커스 적용
                                        else { _this.clearFocus(); } // 포커스 클리어
                                        _this.updateUI();
                                        break;
                                ...
                                case "btnTune": // 튠 조절 여부
                                        switch (idx) {
                                                case 0: // 드랍다운 메뉴 호출 버튼
                                                        ...
                                                        break;
                                                case 1: // 튠 하강
                                                        if (i_current_tune != -1) { changeMedia(_parent._id(), tools_getSourceFileName(_parent._file()) + "_l", tools_getSourceFileName(_parent._file()), null, "tuneDown"); }
                                                        _this.updateUI();
                                                        break;
                                                case 2: // 튠 노멀
                                                        if (i_current_tune != 0) { changeMedia(_parent._id(), tools_getSourceFileName(_parent._file()), tools_getSourceFileName(_parent._file()), null, "tuneNormal"); }
                                                        _this.updateUI();
                                                        break;
                                                case 3: // 튠 상승
                                                        if (i_current_tune != 1) { changeMedia(_parent._id(), tools_getSourceFileName(_parent._file()) + "_h", tools_getSourceFileName(_parent._file()), null, "tuneUp"); }
                                                        _this.updateUI();
                                                        break;
                                        }
                                        break;
                ...
                onTimeUpdate: function () {
                        ...
                        if (i_current_listen != -1) {
                                // 웨이포인트에 의한 일시정지 체크
                                if (_parent._media().paused == false && i_current_listen == 1 && time_waypoint_end != -1 && time + 0.01 > time_waypoint_end) {
                                        if (b_way_loop == true) { // 전용 루프
                                                // 소절 시작 부분으로 돌아감
                                                _parent._module().core.castMove(ar_waypoint[i_current_waypoint][0] + 0.01);
                                        } else { // 루프 아님
                                                // 일시정지
                                                _parent._module().core.castPause();

                                                // UI 갱신을 깔끔하기 위해 약간 뒤로
                                                _parent._module().core.castMove(time_waypoint_end - 0.01);
                ...
                onCastChangeMedia: function (p_data) {
                        ...
                        // 접근자 (자막 관련과 다르게, 음원 기준)
                        _parent._tag().data = (p_data != null) ? p_data : _parent._file();
                        ...
                        // 웨이포인트 배열 만들기
                        if (data.waypoint != null) { _this.setWaypoint(data.waypoint, true); }
                ...
                setNotes: function () {
                        ...
                        // 컨테이너 준비
                        var tag_notes = _parent._tag().notes;
                        var container = $("#notes_" + tag_notes)[0];
                        ...
                        // SVG Controller 배열
                        _this.createSVGCtrlArray(container, data.page, data.verse);
                        ...
                        // 웨이포인트 배열 만들기
                        if (data.waypoint != null) { _this.setWaypoint(data.waypoint); }
                },
                ...
                createFocuserArray: function (ar) {
                        ...
                        for (var ii = 0 ; ii < ar.length ; ii++) {
                                ...
                                ar_focuser[ii].init(head, cat, data.sync[head]);
                        }
                },
                ...
                createLyricsArray: function (amount, ar_source) {
                        ...
                        for (var ii = 0 ; ii < ar_source.length ; ii++) {
                                ...
                                var p_end = (p_start * 1000 + (parseFloat(ar[2]) * 1000)) / 1000;
                                p_start = parseInt(p_start * 100) / 100;
                                p_end = parseInt(p_end * 100) / 100;
                                ar_lyrics[ii] = [p_start, p_end, p_verse];
                        }
                },
                ...
                updateUI: function () {
                        ...
                        if (i_current_listen != -1) {
                                ...
                                if (i_current_listen == 0) { // 전체듣기/소절듣기
                                        if ($(hie.btnListen).hasClass("btnListenPart") == true) { $(hie.btnListen).removeClass("btnListenPart"); }
                                        if ($(hie.btnListen).hasClass("btnListenAll") == false) { $(hie.btnListen).addClass("btnListenAll"); }
                                } else if (i_current_listen == 1) {
                                        if ($(hie.btnListen).hasClass("btnListenAll") == true) { $(hie.btnListen).removeClass("btnListenAll"); }
                                        if ($(hie.btnListen).hasClass("btnListenPart") == false) { $(hie.btnListen).addClass("btnListenPart"); }
                                }
                                if (hie.btnWayloop != null) {
                                        if (b_way_loop == true) { // 전용 루프
                                                if ($(hie.btnWayloop).hasClass("btnWayloopOff") == true) { $(hie.btnWayloop).removeClass("btnWayloopOff"); }
                                                if ($(hie.btnWayloop).hasClass("btnWayloopOn") == false) { $(hie.btnWayloop).addClass("btnWayloopOn"); }
                                        } else {
                                                if ($(hie.btnWayloop).hasClass("btnWayloopOn") == true) { $(hie.btnWayloop).removeClass("btnWayloopOn"); }
                                                if ($(hie.btnWayloop).hasClass("btnWayloopOff") == false) { $(hie.btnWayloop).addClass("btnWayloopOff"); }
                                        }
                                }
                        ...
                        // 포커스 가시여부 조절 버튼
                        if (hie.btnFocus != null) {
                                if (b_focus_note == true) {
                                        if ($(hie.btnFocus).hasClass("btnFocusOff") == true) { $(hie.btnFocus).removeClass("btnFocusOff"); }
                                        if ($(hie.btnFocus).hasClass("btnFocusOn") == false) { $(hie.btnFocus).addClass("btnFocusOn"); }
                                } else {
                                        if ($(hie.btnFocus).hasClass("btnFocusOn") == true) { $(hie.btnFocus).removeClass("btnFocusOn"); }
                                        if ($(hie.btnFocus).hasClass("btnFocusOff") == false) { $(hie.btnFocus).addClass("btnFocusOff"); }
                                }
                        }

                        // 가사 가시여부 조절 버튼
                        if (hie.btnLyrics != null) {
                                if (b_lyrics_visible == true) {
                                        if ($(hie.btnLyrics).hasClass("btnLyricsOff") == true) { $(hie.btnLyrics).removeClass("btnLyricsOff"); }
                                        if ($(hie.btnLyrics).hasClass("btnLyricsOn") == false) { $(hie.btnLyrics).addClass("btnLyricsOn"); }
                                } else {
                                        if ($(hie.btnLyrics).hasClass("btnLyricsOn") == true) { $(hie.btnLyrics).removeClass("btnLyricsOn"); }
                                        if ($(hie.btnLyrics).hasClass("btnLyricsOff") == false) { $(hie.btnLyrics).addClass("btnLyricsOff"); }
                                }
                        }

                        // 튠 조절 버튼
                        if (hie.btnTune != null) {
                                if ($(hie.btnTune).hasClass("btnTuneUp") == true) { $(hie.btnTune).removeClass("btnTuneUp"); }
                                if ($(hie.btnTune).hasClass("btnTuneNormal") == true) { $(hie.btnTune).removeClass("btnTuneNormal"); }
                                if ($(hie.btnTune).hasClass("btnTuneDown") == true) { $(hie.btnTune).removeClass("btnTuneDown"); }
                                switch (i_current_tune) {
                                        case -1: $(hie.btnTune).addClass("btnTuneDown"); break;
                                        case 0: $(hie.btnTune).addClass("btnTuneNormal"); break;
                                        case 1: $(hie.btnTune).addClass("btnTuneUp"); break;
                                }
                        }
                },
                ...
                setFocus: function (head, page, idx) {
                        ...
                        // 음표
                        if (b_focus_note == true) {
                                ar_svg_ctrl[page - 1].noteOn(head, idx);
                        }

                        // 기억
                        obj_remember_focus.ready = true;
                        obj_remember_focus.head = head;
                        obj_remember_focus.page = page;
                        obj_remember_focus.idx = idx;
                },
                releaseFocus: function (head, page, idx) {
                        ...
                        // 음표
                        ar_svg_ctrl[page - 1].noteOff(head, idx);

                        // 기억
                        obj_remember_focus.ready = false;
                },
                revertFocus: function () {
                        ...
                        //
                        if (obj_remember_focus.ready == true) {
                                _this.setFocus(obj_remember_focus.head, obj_remember_focus.page, obj_remember_focus.idx);
                        }
                },
                clearFocus: function () {
                        // 개발
                        ...
                        //
                        if (obj_remember_focus.ready == true) {
                                ar_svg_ctrl[obj_remember_focus.page - 1].noteOff(obj_remember_focus.head, obj_remember_focus.idx);
                        }
                },
...
var mediaplayer_compo_notes_focuser = function (p_parent) {
        ...
        return {
                ...
                // 초기화
                init: function (head, cat, ar_sync) {
                        // 연결
                        _this = this;
                        ...
                        switch (s_focus_category) {
                                ...
                                case "html": co_custom_controller = new htmlControllerInit(p_option); break;
                ...
                setFocus: function (idx) {
                        ...
                        switch (s_focus_category) {
                                case "svg":
                                        ...
                                        break;
                                case "kj":
                                        console.log("focus kj:" + index);
                                        co_custom_controller.imageOn(index);
                                        break;
                                case "count":
                                        console.log("focus count:" + index);
                                        var div = $(document).find(".playCounter")[0];
                                        $(div).css("display", "inline-block");
                                        if ($(div).hasClass("no1") == true) { $(div).removeClass("no1"); }
                                        if ($(div).hasClass("no2") == true) { $(div).removeClass("no2"); }
                                        if ($(div).hasClass("no3") == true) { $(div).removeClass("no3"); }
                                        if ($(div).hasClass("no4") == true) { $(div).removeClass("no4"); }
                                        if ($(div).hasClass("no5") == true) { $(div).removeClass("no5"); }
                                        if ($(div).hasClass("no6") == true) { $(div).removeClass("no6"); }
                                        $(div).addClass("no" + index);
                                        break;
                                case "html":
                                        console.log("focus html:" + index);
                                        ctrl_custom.noteOn(s_focus_category, index);
                                        break;
                                case "path":
                                        console.log("focus path:" + index);
                                        ctrl_custom.moveTo(index);
                                        break;
                        }
                },
                releaseFocus: function () {
                        ...
                        switch (s_focus_category) {
                                case "svg":
                                        ...
                                        break;
                                case "kj":
                                        console.log("release kj:" + index);
                                        co_custom_controller.imageOff(index);
                                        break;
                                case "count":
                                        console.log("release count:" + index);
                                        var div = $(document).find(".playCounter")[0];
                                        $(div).css("display", "none");
                                        break;
                                case "html":
                                        console.log("release html:" + index);
                                        co_custom_controller.noteOff(s_focus_category, index);
                                        break;
                        }
        ...
        return {
                ...
                onUpdateUI: function () {
                        ...
                        if (_parent._media().paused == true) {
                                if ($(_parent._ele()).hasClass("on") == true) { $(_parent._ele()).removeClass("on"); }
                        } else {
                                if ($(_parent._ele()).hasClass("on") == false) { $(_parent._ele()).addClass("on"); }
                        }
                },
...
var mediaplayer_compo_thumbnail = function (p_parent) {
        ...
        return {
                ...
                init: function () {
                        ...
                        // 접근자
                        _parent._tag().data = ($(_parent._ele()).attr("data") != null) ? $(_parent._ele()).attr("data") : _parent._id();
                        _parent._tag().thumbnail = ($(_parent._ele()).attr("thumbnail") != null) ? $(_parent._ele()).attr("thumbnail") : _parent._id();
                        ...
                        // 데이터 정리
                        var tag_data = _parent._tag().data;
                        var tag_thumbnail = _parent._tag().thumbnail;
                        var dic = dicMediaData["data_" + tag_data];
                        ar_thumbnail_capture_time = dic.thumbnail;
                        i_thumbnail_capture_idx = 0;

                        // 오브젝트 연결
                        ele_thumbnail_container = $(document).find("#thumbnail_" + tag_thumbnail);
                        ...
                        document.addEventListener("mousemove", function (event) {
                                ...
                                // 인아웃 판단
                                var inout = tools_chkInout(event, ele_thumbnail_container.find(".toucharea")[0]);
...
var mediaplayer_compo_btnUpdown = function (p_parent) {
        ...
        // state
        var b_current_up = true; // up down 상태 (changeMedia 를 통해 변경 됨)
        ...
        return {
                ...
                init: function () {
                        ...
                        // 커스터마이저
                        _parent._module().customizer.btnUpdown_onInit();
                ...
                // 참조
                b_current_up: function (b) { b_current_up = b; },
                ...
                onHardReset: function () {
                        // 체크
                        if (b_current_up == false) {
                                _this.onButtonClick("btnUpdown", 1, $(_parent._hierarchy().btnUpdown));
                                _this.updateUI();
                        } else {
                                _this.onReset();
                        }
                ...
                onButtonClick: function (tag, idx, btn) {
                        ...
                        var current = "normal";
                        switch (name) {
                                case "05_00_01_vocalization_01":
                                        index = 1;
                                        current = "high";
                                        break;
                                case "05_00_02_vocalization_01":
                                        index = 2;
                                        current = "high";
                                        break;
                                case "05_00_03_vocalization_01":
                                        index = 3;
                                        current = "high";
                                        break;
                                case "05_00_01_vocalization_02":
                                        index = 1;
                                        current = "low";
                                        break;
                                case "05_00_02_vocalization_02":
                                        current = "low";
                                        index = 2;
                                        break;
                                case "05_00_03_vocalization_02":
                                        current = "low";
                                        index = 3;
                                        break;
                        }
                        ...
                        switch (idx) {
                                case -1:
                                        if (current != "low") {
                                                switch (index) {
                                                        case 1: changeMedia(id, "05_00_01_vocalization_02", null, null, "updownDown"); break;
                                                        case 2: changeMedia(id, "05_00_02_vocalization_02", null, null, "updownDown"); break;
                                                        case 3: changeMedia(id, "05_00_03_vocalization_02", null, null, "updownDown"); break;
                                                }
                                        }
                                        break;
                                case 1:
                                        if (current != "high") {
                                                switch (index) {
                                                        case 1: changeMedia(id, "05_00_01_vocalization_01", null, null, "updownUp"); break;
                                                        case 2: changeMedia(id, "05_00_02_vocalization_01", null, null, "updownUp"); break;
                                                        case 3: changeMedia(id, "05_00_03_vocalization_01", null, null, "updownUp"); break;
                                                }
                                        }
                                        break;
                        }
                ...
                updateUI: function (str) {
                        ...
                        // 갱신
                        if ($(hie.btnUpdownUp).hasClass("on") == true) { $(hie.btnUpdownUp).removeClass("on"); }
                        if ($(hie.btnUpdownDown).hasClass("on") == true) { $(hie.btnUpdownDown).removeClass("on"); }

                        // 분기
                        switch (b_current_up) {
                                case true: $(hie.btnUpdownUp).addClass("on"); break;
                                case false: $(hie.btnUpdownDown).addClass("on"); break;
                        }
                },
        }
}