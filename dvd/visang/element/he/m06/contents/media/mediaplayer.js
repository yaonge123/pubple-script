...
var PATH_MEDIA_VIDEO = (dev_mode == true) ? "../ref_data/[비상교육] 초등_실과 6_동영상/" : "../ref_data/[비상교육] 초등_실과 6_동영상/"; // 비디오 미디어 파일 경로
...
var VIDEO_INOUT_MARGIN = 100; // 인아웃 체크 여유 공간(상하좌우 전부 적용)
