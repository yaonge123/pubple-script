...
/**
* @fileoverview 미디어플레이어 유닛 클래스(mediaplayer_template).
* 미디어플레이어 유닛 초기화, 참조 관련 메서드, 유닛 단위 호출 메서드로 구성된다.
*/
var mediaplayer_template = function (p_type, p_ele) {
        /**
        * 필요한 기능들을 위한 컴포넌트들(_module) 및 관련 정보 오브젝트(_hierarchy:엘리먼트접근, _tag:참조값정보) 등을 생성, 보관한다.
        * @namespace mediaplayer_template
        * @class mediaplayer_template.js 에 위치. 미디어플레이어 유닛 클래스.
        * @param {object} p_parent - 이 클래스를 생성한 부모 클래스
        * @param {element} p_ele - 미디어플레이어를 생성한 엘리먼트
        */
        ...
        return {
                ...
                init: function (p_id) {
                        /** 
                        * 초기화. 다음 기능들을 수행한다. 1:커스터마이저, 코어 및 컴포넌트 생성 및 초기화, 2:개별화 관련 처리, 3:코어 시작.
                        * @method init
                        * @memberof mediaplayer_template
                        * @param p_id {string} 미디어플레이어 id (엘리먼트의 id 속성)
                        */
                ...
                // 제어
                /** 
                * 제어 메서드. mediaplayer_hq 에서 호출된 제어 메서드를 기능에 따라 컴포넌트들에게 전달한다. 세부 내용은 hq 의 메서드들을 참조할 것.
                * @method [메서드 그룹] reset & play & playPartial & pause & stop & changeMedia
                * @memberof mediaplayer_template
                */
                ...
                getMediaAndSleep: function () {
                        /** 
                        * 미디어 이동을 위한 상태 저장 반환 및 미디어플레이어를 초기화한다.
                        * @method getMediaAndSleep
                        * @returns {object} 미디어플레이어 상태 저장 오브젝트
                        * @memberof mediaplayer_template
                        */
                ...
                setMedia: function (obj) {
                        /** 
                        * 상태 저장 오브젝트를 컴포넌트들에게 전달한다.
                        * @method setMedia
                        * @param obj {object} 미디어플레이어 상태 저장 오브젝트
                        * @memberof mediaplayer_template
                        */
                ...
                setCompoUIOrder: function () {
                        /** 
                        * 개별화. COMPO_UI_ORDER 를 참조하여 UI 버튼의 순서를 조정.
                        * @method setCompoUIOrder
                        * @memberof mediaplayer_template
                        */
                ...
                // 문자열로 컴포넌트의 UI 구성물 얻기
                getCompoUI: function (str) {
                        /** 
                        * [tools] 개별화. UI 재구성을 위해 각 컴포넌트 들에 UI 구성물을 반환. 적용이 필요한 컴포넌트들을 하나씩 추가 중.
                        * @method getCompoUI
                        * @param str {string} 컴포넌트명
                        * @returns {array} UI 엘리먼트 배열
                        * @memberof mediaplayer_template
                        */
