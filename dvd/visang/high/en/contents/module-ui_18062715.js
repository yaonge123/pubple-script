    ...
    return {
        ...
        initTransBtn: function() {
            ...
            if (btnAllShow) {
                btnAllShow.addEventListener("click", function (e) {
                    ...
                    if (this.classList.contains("p_ex")) {
                        korEls = this.closest(".popWrap").getElementsByClassName("tKor");
                        korLen = korEls.length;

                        for (i = 0; i < korLen; i++) {
                            korClass = korEls[i].classList;
                            korClass.toggle("active");
                            korClass.toggle("on");
                        }
                    } else {
                        getEls(e);
        ...
        initWordPopup: function() {
            ...
            for (i = 0; i < wordLen; i++) {
                ...
                mean = wordInfo.mean;
                eg = wordInfo.eg;
                eg = eg.replace(/\/c{1}/, "<span class='color'>");
                eg = eg.replace(/\/c/, "</span>");
        ...
        initPreviewWord: function() {
            ...
            //     <div class="word_d caption">
            //         <div class="tEng">
            //             She is proud of what she has <span class="color">accomplished</span> in the medical field.
			// 												</div>
            //         <div class="tKor active">
            //             그녀는 의료 분야에서 그녀가 성취한 것을 자랑스러워한다.
			// 												</div>
            //     </div>
            //     <!--  Audio Player Btn  -->
			// 											<div class="inner_mp3_wrap">
            //         <div class="btn_mp_audio"></div>
            //     </div>
            // </div>
            // html 삽입
        ...
        initDraggableItem: function() {
            ...
            var quickBtnClass = document.getElementById("quickBtn").classList;
            ...
            var startDragItem = function(e) {
                ...
                document.addEventListener("mouseup", finishDragItem);
            }

            var dragItem = function(e) {
                // console.log('dragItem', );
                quickBtnClass.add("onDrag");
                ...
                quickMenu.style.top = (quickMenu.offsetTop - newPosY) + "px";
                quickMenu.style.left = (quickMenu.offsetLeft - newPosX) + "px";
            }
            ...
            var finishDragItem = function(e) {
                ...
                document.removeEventListener("mouseup", finishDragItem);
            }

            quickMenu.addEventListener("mousedown", startDragItem);
        }
    }
}());